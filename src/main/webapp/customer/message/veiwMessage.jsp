...
<body>
    ...
    <div id="wrapper">
      ...
      <c:forEach var="com" items="${MessageDetails}" > 
	<c:set var="messageid" value="${com.messageid}" />
	...
	<c:set var="agentid" value="${com.agentid}" />
		...
		<c:url value="customer/message/updateMessage.jsp" var="updateMessage">
	...
	<c:url value="customer/message/deleteMessage.jsp" var="deleteMessage">
	<c:param name="messageid" value="${messageid}"/>
	<c:param name="name" value="${name}"/>
	<c:param name="phone" value="${phone}"/>
	<c:param name="email" value="${email}"/>
  ...
  <div class="card-body">
    ...
    <h5 class="card-title">Complain Id: ${com.messageid}</h5>
    <h6 class="card-subtitle mb-2 text-body-secondary">Name: ${com.name}</h6>
    <p class="card-text">Complain: ${com.description}</p>
    <a href="${updateMessage}" class="card-link">update</a>
    <a href="${deleteMessage}" class="card-link">Delete</a>
  </div>
</div>
