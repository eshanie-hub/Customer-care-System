    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link" href="profile.jsp" id="userDropdown" role="button">
                                <span class="mr-2 d-none d-lg-inline text-gray-600">Update Profile</span>
                            </a>
                         </li>
                         <li class="nav-item dropdown no-arrow">
                            <a class="nav-link" href="delete.jsp" id="userDropdown" role="button">
                                <span class="mr-2 d-none d-lg-inline text-gray-600">Delete Profile</span>
                            </a>
                         </li>
                         <li class="nav-item dropdown no-arrow">
                            <a class="nav-link" href="login.jsp" id="userDropdown" role="button">
             ...
             <h1 class="h3 mb-0 text-gray-800">Update Message</h1>
                      
             
<form method="post" action="../../UpdateMessage" class="row g-3">

    <input type="text" name="messageid" value="<%= messageid %>" class="form-control" hidden>
 ...
 <div class="col-md-4">
    ...
    <input type="description" name="description" value="<%= description %>" class="form-control" >
  </div>
  ...
  <input type="text" name="agentid" value="<%= agentid %>" class="form-control" hidden>
	...
	<input type="submit" name="submit" value="Update data" class="btn btn-primary mt-5 mx-auto" >
