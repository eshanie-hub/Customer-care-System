    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <h1 class="h3 mb-0 text-gray-800">Delete Message</h1>
                      
             
<form method="post" action="../../DeleteMessage" class="row g-3">
 ...
 <div class="col-md-4">
    ...
    <input type="description" name="description" value="<%= description %>" class="form-control" readonly>
  </div>
