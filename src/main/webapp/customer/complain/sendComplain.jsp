...
<body>
	...
	%>
		<c:url value="viewComplain.jsp" var="complain">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <h1 class="h3 mb-0 text-gray-800">Create Complain</h1>
              
             

<form method="post" action="../../sendServlet" class="row g-3">
 ...
 <div class="col-md-4 mb-5">
	...
	<input type="submit" name="submit" value="sent Complain" class="btn btn-primary mt-5 mx-auto" >
