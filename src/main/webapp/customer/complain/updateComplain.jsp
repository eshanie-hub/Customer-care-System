    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <h1 class="h3 mb-0 text-gray-800">Update Complain</h1>
              
             
<form method="post" action="../../ComplainUpdate" class="row g-3">
	<input type="text" name="comId" value="<%= comId %>" class="form-control">
 ...
 <div class="col-md-4">
    ...
    <input type="text" name="complain" value="<%= complain %>" class="form-control">
  </div>
