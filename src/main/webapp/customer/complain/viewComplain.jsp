...
<!-- Page Wrapper -->
    <div id="wrapper">
      ...
      <c:forEach var="com" items="${complainDetails}" > 
	...
	<c:set var="comId" value="${com.comId}" />
		...
		<c:url value="customer/complain/updateComplain.jsp" var="updateComplain">
	...
	<c:url value="customer/complain/deleteComplain.jsp" var="deleteComplain">
...
<div class="card m-2" style="width: 18rem; ">
  <div class="card-body">
    ...
    <h5 class="card-title">Complain Id: ${com.comId}</h5>
    <h6 class="card-subtitle mb-2 text-body-secondary">Name: ${com.name}</h6>
    <p class="card-text">Complain: ${com.complain}</p>
    <a href="${updateComplain}" class="card-link">update</a>
    <a href="${deleteComplain}" class="card-link">Delete</a>
  </div>
</div>
