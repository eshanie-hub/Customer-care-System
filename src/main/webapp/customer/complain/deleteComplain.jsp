    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <h1 class="h3 mb-0 text-gray-800 mt-4">Delete complain</h1>
                      
             
<form method="post" action="../../DeleteComplain" class="row g-3">

    <input type="text" name="cusid" value="<%= id %>" class="form-control" >
