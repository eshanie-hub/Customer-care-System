    ...
    <div class="flex row login">
      <div class="col image-side">
       ...
       <div class="col-5 text-center mt-5">
        ...
        <input type="text" name="username" class="mb-3 form-control text-center" placeholder="Enter Username" required/> <br><br>

        <p class="mt-1">Password:</p>
        <input type="password" name="password" class="form-control text-center" placeholder="Enter Password" required/> <br><br>
        
        <input type="submit" value="Login" class="btn btn-primary mt-3">
        <p class="mt-2 mb-5"><a href="register.jsp">Register</a></p>
