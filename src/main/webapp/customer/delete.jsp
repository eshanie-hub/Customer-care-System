    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <h1 class="h3 mb-0 text-gray-800">Delete profile</h1>
                      
             
<form method="post" action="../Delete" class="row g-3">
 ...
 <div class="col-md-4 mb-5">
   ...
   <div class="col-md-8">
    ...
    <input type="text" name="uname" value="<%= userName %>" class="form-control" readonly>
  </div>
 <div class="col-md-4">
    <label class="form-label">Password</label>
    <input type="password" name="pass" value="<%= password %>" class="form-control" readonly>
  </div>
