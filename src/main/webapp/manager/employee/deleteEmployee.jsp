...
%>
  ...
  <div class="container">
	<div class="mt-5 d-flex flex-row" >
		...
		<a href="manager/employee/viewEmployee.jsp" class="col-md-2 btn btn-primary text-center m-3 ">Delete Employee</a>
		<a href="customer/login.jsp" class="btn btn-primary col-md-2 text-center m-3">logout</a>
	</div>

<form method="post" action="../../EmployeeDelete" class="row g-3">
...
<div class="col-md-12 mb-5">
  ...
  <div class="col-md-6 mb-5">
	...
	<input type="submit" name="submit" value="Delete Employee" class="btn btn-primary mt-5 mx-auto" >
</form>
